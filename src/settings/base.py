...
LANG = "pt-br"
DRIVE_SECRET = "/home/osboxes/secrets/client_secrets_2.json"
...
LOGGING = {
    ...
    "formatters": {
        ...
        "simple": {"format": "%(levelname)s %(asctime)s %(name)s %(message)s"},  # noqa
    },
    "handlers": {
        "console": {
    ...
    "loggers": {
        ...
        "bettercall": {"handlers": ["console"], "level": "INFO", "propagate": False,},
